--
-- Script To Update dbo.tFindings Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--

delete from tUserRoles where UserId NOT IN (select UserId from tUsers);

update tUsers set IsActive = '1';

delete from tUserGroups where UserId NOT IN (select UserId from tUsers);
...
IF @@TRANCOUNT = 1
   ALTER TABLE [dbo].[tFindings]
      ADD [AudioUserName] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
GO
...
--
-- Script To Update dbo.tGroupRelations Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tImages Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tLog Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tModalityDetails Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tProcedures Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tSeries Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tStations Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tStudies Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
IF @@TRANCOUNT = 1
   ALTER TABLE [dbo].[tStudies]
      ADD [AccessionNumber] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
GO
...
--
-- Script To Update dbo.tStudyGroups Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tStudyStatusTypes Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
PRINT 'Updating dbo.tStudyStatusTypes Table'
GO
...
IF @@TRANCOUNT = 1
   CREATE TABLE [dbo].[tmp_tStudyStatusTypes] (
   [StudyStatusTypeId] [int] IDENTITY (1, 1) NOT NULL,
...
IF @@TRANCOUNT = 1
   SET IDENTITY_INSERT [dbo].[tmp_tStudyStatusTypes] ON
GO
...
IF @@TRANCOUNT = 1
   INSERT INTO [dbo].[tmp_tStudyStatusTypes] ([StudyStatusTypeId], [Status], [ColumnOrder])
   SELECT [StudyStatusTypeId], [Status], [ColumnOrder]
   FROM [dbo].[tStudyStatusTypes]
GO
...
IF @@TRANCOUNT = 1
   SET IDENTITY_INSERT [dbo].[tmp_tStudyStatusTypes] OFF
GO
...
IF @@TRANCOUNT = 1
   DROP TABLE [dbo].[tStudyStatusTypes]
GO

sp_rename N'[dbo].[tmp_tStudyStatusTypes]', N'tStudyStatusTypes'
...
IF @@TRANCOUNT = 1
   ALTER TABLE [dbo].[tStudyStatusTypes] ADD CONSTRAINT [PK_tStudyStatusTypes] PRIMARY KEY CLUSTERED ([StudyStatusTypeId])
GO
...
IF @@TRANCOUNT = 1
BEGIN
   PRINT 'dbo.tStudyStatusTypes Table Updated Successfully'
   COMMIT TRANSACTION
END ELSE
BEGIN
   PRINT 'Failed To Update dbo.tStudyStatusTypes Table'
END
GO

--
-- Script To Update dbo.tUserGroups Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tUserRoles Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Update dbo.tUsers Table In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
IF @@TRANCOUNT = 1
   ALTER TABLE [dbo].[tUsers]
      ALTER COLUMN [LoginName] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
GO
...
IF @@TRANCOUNT = 1
   ALTER TABLE [dbo].[tUsers]
      ALTER COLUMN [Name] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
GO
...
IF @@TRANCOUNT = 1
   ALTER TABLE [dbo].[tUsers]
      ALTER COLUMN [Password] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
GO
...
--
-- Script To Create dbo.FindingsCount View In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
PRINT 'Creating dbo.FindingsCount View'
GO
...
exec('CREATE VIEW dbo.FindingsCount
AS
SELECT     dbo.tUsers.Name, dbo.tModalities.Name AS Modality, dbo.tStudies.StudyDate
FROM         dbo.tFindings INNER JOIN
                      dbo.tUsers ON dbo.tFindings.AudioUserId = dbo.tUsers.UserId INNER JOIN
                      dbo.tStudies ON dbo.tFindings.StudyId = dbo.tStudies.StudyId INNER JOIN
                      dbo.tModalities ON dbo.tStudies.ModalityId = dbo.tModalities.ModalityId
WHERE     (dbo.tStudies.StudyDate > CONVERT(DATETIME, ''2008-08-01 00:00:00'', 102))')
GO
...
IF @@TRANCOUNT = 1
BEGIN
   PRINT 'dbo.FindingsCount View Added Successfully'
   COMMIT TRANSACTION
END ELSE
BEGIN
   PRINT 'Failed To Add dbo.FindingsCount View'
END
GO

--
-- Script To Create dbo.StudyCount View In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
PRINT 'Creating dbo.StudyCount View'
GO
...
exec('CREATE VIEW dbo.Volume_Report_Test
AS
SELECT     COUNT(StudyId) AS [Number of Studies]
FROM         dbo.tStudies
WHERE     (StudyDate > ''08/01/2008'')')
GO
...
IF @@TRANCOUNT = 1
BEGIN
   PRINT 'dbo.StudyCount View Added Successfully'
   COMMIT TRANSACTION
END ELSE
BEGIN
   PRINT 'Failed To Add dbo.StudyCount View'
END
GO

--
-- Script To Create dbo.GetActiveUsersByGroupAndRole Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.GetActiveUsersByRole Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.GetProcedure Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.GetProceduresByModality Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Delete dbo.GetTemplatesAndUsers Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
PRINT 'Deleting dbo.GetTemplatesAndUsers Procedure'
GO

   DROP PROCEDURE [dbo].[GetTemplatesAndUsers]
GO
...
IF @@TRANCOUNT = 1
BEGIN
   PRINT 'dbo.GetTemplatesAndUsers Procedure Deleted Successfully'
   COMMIT TRANSACTION
END ELSE
BEGIN
   PRINT 'Failed To Delete dbo.GetTemplatesAndUsers Procedure'
END
GO

--
-- Script To Create dbo.GroupsDeleteCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.GroupsInsertCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.GroupsSelectCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.GroupsUpdateCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.InsertStudyDefaultGroup Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.ModalitiesDeleteCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.ModalitiesInsertCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.ModalitiesSelectCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.ModalitiesUpdateCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.ProcedureDeleteCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.ProcedureInsertCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.ProcedureSelectCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.ProcedureUpdateCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.UsersDeleteCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.UsersInsertCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.UsersSelectCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
...
--
-- Script To Create dbo.UsersUpdateCommand Procedure In localhost\SQLEXPRESS.RIS_MRA
-- Generated Sunday, May 17, 2009, at 03:26 AM
--
-- Please backup localhost\SQLEXPRESS.RIS_MRA before executing this script
--
