...
#import "E:\\MyProjects\\RIS\trunk\\eFilm\\CustomeMessageExample\\eFilm.tlb" no_namespace

// CEFilm wrapper class

class CEFilm : public COleDispatchDriver
{
public:
	CEFilm(){} // Calls COleDispatchDriver default constructor
	CEFilm(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CEFilm(const CEFilm& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
